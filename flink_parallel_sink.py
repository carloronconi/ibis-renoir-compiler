...
def word_count(input_path, output_path):
    ...
    #     string_array)
    # 
    # env = StreamExecutionEnvironment(j_stream_execution_environment).set_parallelism(4)
...
# to run:
# python flink_parallel_sink.py --input flink_input.txt --output flink_output.txt
# in this case, output is parallel: it doesn't get merged into a single file!
